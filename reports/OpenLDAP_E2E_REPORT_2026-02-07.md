...
- Instances: reports/logs/ec2_openldap_instances_2026-02-07.json
...
- VPC test matrix: reports/logs/e2e_vpc_results_2026-02-07.csv
...
|---|---|---|
| live | e2e-live-20260207213055 | no |
| dr | e2e-dr-20260207213113 | no |
...
- If a VPC has only 1 master, MirrorMode cannot be validated in that VPC (tests mark mirrormode=no).
